pipeline{
        ...
        stage('Docker build'){
            steps{
                ...
                sshagent(['ec2login']) {
                    ...
                    ssh ubuntu@15.206.73.0 sudo docker rm -f web1
                    """
                }
            }
        }
    ...
    post{always{emailext body: 'hello from jenkins job pipeline', subject: 'Jenkins', to: 'krishnabgvk2691@gmail.com, vamsiguru00@gmail.com'}}
}
